...
Use cautious language for craft identification and never present a guess as a verified fact.
Create useful marketplace copy without changing factual meaning.
Return concise tags and a market-match explanation that is clearly a recommendation, not a fact.` },
        ...
        format: {
          ...
          schema: {
            ...
            properties: {
              ...
              market_match: { type: 'string' },
              confidence: { type: 'integer', minimum: 0, maximum: 100 },
              needs_confirmation: { type: 'array', items: { type: 'string' } }
            },
            required: ['title','craft','origin','materials','technique','description','story','tags','market_match','confidence','needs_confirmation']
          }
        }
      }
    });
