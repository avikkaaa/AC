...
conn?.addEventListener?.('change',()=>{if(localStorage.getItem(KEY)==null){enabled=Boolean(conn.saveData||['slow-2g','2g','3g'].includes(conn.effectiveType));apply()}});
